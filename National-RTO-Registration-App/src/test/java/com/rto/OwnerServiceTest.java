...
public class OwnerServiceTest {
	...
	public void saveOwnerNegative() throws UserDefineException{
		...
		/*UserDefineException udf1=new UserDefineException("unkown exp");
		when(ownerRepository.save(entity)).thenThrow(UserDefineException.class);
		UserDefineException udf=new UserDefineException("unkown exp");
		OwnerEntity udf2=ownerService.saveOwner(entity);*/
		UserDefineException udf1=new UserDefineException("Null pointerExcetion");
		when(entity==null).thenThrow(new UserDefineException("Null pointerExcetion"));
		OwnerEntity ownerEntity = ownerService.saveOwner(entity);
		assertEquals(udf1,ownerEntity);
	}
}
